...
import org.xbib.graphics.imageio.plugins.png.pngj.chunks.PngChunkIEND;
import org.xbib.graphics.imageio.plugins.png.pngj.chunks.PngChunkIHDR;
...
import org.xbib.graphics.imageio.plugins.png.pngj.pixels.PixelsWriter;
import org.xbib.graphics.imageio.plugins.png.pngj.pixels.PixelsWriterDefault;
...
public class PngWriter implements Closeable {
     ...
     *
     * @param chunks
     * @param predicate The chunks (ancillary or PLTE) will be copied if and only if
     *                  predicate matches
