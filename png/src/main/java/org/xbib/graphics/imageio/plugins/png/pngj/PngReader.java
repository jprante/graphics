...
import org.xbib.graphics.imageio.plugins.png.pngj.chunks.PngChunkFCTL;
import org.xbib.graphics.imageio.plugins.png.pngj.chunks.PngChunkFDAT;
import org.xbib.graphics.imageio.plugins.png.pngj.chunks.PngChunkIDAT;
...
public class PngReader implements Closeable {
     ...
     *
     * @param inputStream
     * @param shouldCloseStream The stream will be closed in case of exception (constructor
    ...
    /**
     * @param forceLoadingOfFirstChunks If true, chunks before IDAT will be load if needed
     ...
     *
     * @param nRows     how many rows to read (default: imageInfo.rows; negative:
     *                  autocompute)
