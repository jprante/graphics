...
public interface GhostscriptLibrary extends Library {
     ...
     * @param len pr Length
     * @return 0 if everything is OK, less than 0 otherwise
     * @see gsapi_revision_s
     */
    int gsapi_revision(Structure pr, int len);
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_new_instance(Pointer pinstance, Pointer caller_handle);
     ...
     */
    void gsapi_delete_instance(Pointer instance);
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_exit(Pointer instance);
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_init_with_args(Pointer instance, int argc, String[] argv);
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_run_string(Pointer instance, String str, int user_errors,
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_run_string_with_length(Pointer instance, String str,
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_run_string_begin(Pointer instance, int user_errors,
                               IntByReference pexit_code);
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_run_string_continue(Pointer instance, String str,
                                  int length, int user_errors, IntByReference pexit_code);
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_run_string_end(Pointer instance, int user_errors,
                             IntByReference pexit_code);
     ...
     *                    interpreter output), if a negative value is used errors are returns
     *                    directly by the function.
     * @param pexit_code exit code
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_run_file(Pointer instance, String file_name,
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_set_stdio(Pointer instance, stdin_fn stdin_fn,
     ...
     * @return 0 if everything is OK, less than 0 otherwise
     */
    int gsapi_set_display_callback(Pointer instance, Structure callback);
     ...
     */
    interface stdin_fn extends Callback {
        int callback(Pointer caller_handle, Pointer buf, int len);
    }
     ...
     */
    interface stdout_fn extends Callback {
        int callback(Pointer caller_handle, String str, int len);
    }
     ...
     */
    interface stderr_fn extends Callback {
        int callback(Pointer caller_handle, String str, int len);
    }
     ...
     */
    class gsapi_revision_s extends Structure {
     ...
     */
    class display_callback_s extends Structure {
         ...
         * required. Ghostscript must only use this callback if version_major greater or equal than
         * 2.
         */
        ...
        public interface display_open extends Callback {
            ...
            int callback(Pointer handle, Pointer device);
        }
        ...
        public interface display_presize extends Callback {
            ...
            int callback(Pointer handle, Pointer device, int width,
        ...
        public interface display_page extends Callback {
            ...
            int callback(Pointer handle, Pointer device, int copies,
                         int flush);
        }
        ...
        public interface display_update extends Callback {
            ...
            int callback(Pointer handle, Pointer device, int x, int y,
                         int w, int h);
        }
        ...
        public interface display_memalloc extends Callback {
            ...
            void callback(Pointer handle, Pointer device, NativeLong size);
        }
        ...
        public interface display_memfree extends Callback {
            ...
            int callback(Pointer handle, Pointer device, Pointer mem);
        }

        public interface display_separation extends Callback {

            int callback(Pointer handle, Pointer device, int component,
     ...
     */
    class gs_main_instance extends PointerType {
