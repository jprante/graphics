...
public class ImageLineInt implements IImageLine, IImageLineArray {
     ...
     * {@link ImageLineHelper#palette2rgb(ImageLineInt, org.xbib.graphics.imageio.plugins.png.pngj.chunks.PngChunkPLTE, int[])}
    ...
    /**
     * @param imgInfo Inmutable ImageInfo, basic parameters of the image we are
     *                reading or writing
     */
