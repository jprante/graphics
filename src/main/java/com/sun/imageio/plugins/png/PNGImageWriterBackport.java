...
public final class PNGImageWriterBackport extends ImageWriter {
    ...
    private int totalPixels; // Total number of pixels to be written by write_IDAT
    private int pixelsDone; // Running count of pixels written by write_IDAT

    PNGImageWriterBackport(ImageWriterSpi originatingProvider) {
    ...
    private void encodePass(ImageOutputStream os,
        ...
        byte[][] filteredRows = new byte[5][bytesPerRow + bpp];
