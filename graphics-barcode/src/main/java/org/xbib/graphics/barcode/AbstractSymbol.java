...
/**
 * Abstract barcode symbology class.
 */
public abstract class AbstractSymbol implements Symbol {

    private final List<Rectangle2D.Double> rectangles = new ArrayList<>();

    private final List<TextBox> texts = new ArrayList<>();

    private final List<Hexagon> hexagons = new ArrayList<>();

    private final List<Ellipse2D.Double> target = new ArrayList<>();
    ...
    protected SymbolDataType inputSymbolDataType = SymbolDataType.ECI;
     ...
     * </ul>
     *
     * @param symbolDataType A <code>DataType</code> value which specifies the type of data
     */
    @Override
    public void setDataType(SymbolDataType symbolDataType) {
