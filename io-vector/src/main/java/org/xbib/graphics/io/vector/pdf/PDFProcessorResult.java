...
import org.xbib.graphics.io.vector.util.FormattingWriter;
...
public class PDFProcessorResult implements ProcessorResult {
    ...
    public static String toString(PDFObject obj) throws IOException {
    ...
    private void initPage() throws IOException {
        ...
        dict = DataUtils.map(new String[]{"Type"}, new Object[]{"Catalog"});
